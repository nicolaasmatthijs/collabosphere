...
var postInitialize = module.exports.postInitialize = function(app, router) {
  ...
  //app.get('app/components/assetLibrary/assetLibrary.html',function(req,res){
  //  res.sendfile('public/app/components/assetLibrary/assetLibrary.html');
  //});
  //app.get('app/components/engagementIndex/engagementIndex.html',function(req,res){
  //  res.sendfile('public/app/components/engagementIndex/engagementIndex.html');
  //});
