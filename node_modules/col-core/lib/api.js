...
var initializeServer = function(callback) {
  ...
  // A router for all routes on /api/courses/:api_domain/:course_id
 ...
 *
 * @param  {Object}         apiRouter       The router for all routes on /api/courses/:api_domain/:course_id
 * @api private
 */
var initializeAuthorizationMiddleware = function(apiRouter) {
  ...
  apiRouter.use(function(req, res, next) {
    ...
    // is `/api/courses/ucberkeley.canvas.com/21312`
    var apiDomain = req.baseUrl.split('/')[3];
    var courseId = req.baseUrl.split('/')[4];
