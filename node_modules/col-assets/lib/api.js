...
var Embdr = require('processr-client');
var Joi = require('joi');
  ...
  CategoriesAPI.getCategoriesById(ctx, categories, function(err, categories) {
    ...
    asset.save().complete(function(err, asset) {
      ...
      asset.setCategories(categories).complete(function(err) {
        ...
        // Generate thumbnails and an embed code for the asset
        generateAssetPreviews(asset);
 ...
 * TODO
 */
var generateAssetPreviews = function(asset) {
  var embdr = new Embdr('R7fyLMRrR2IF1t265ShCQISh9BVhM8Yw');
  //console.log(asset.download_url);
  //var stream = new PassThrough();
  var r = request(asset.download_url);
  embdr.process(r, {
