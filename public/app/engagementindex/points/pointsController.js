...
(function(angular) {
  ...
  angular.module('collabosphere').controller('PointsController', function(pointsFactory, userFactory, $scope) {
    ...
    var saveActivityTypeConfiguration = $scope.saveActivityTypeConfiguration = function() {
      // Switch to view mode
      $scope.editMode = false;
      pointsConfigurationFactory.editActivityTypeConfiguration(activityTypeConfiguration);
    };
